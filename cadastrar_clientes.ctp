<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Cadastrar clientes</h4>
                <div class="row">
                    <form class="form-horizontal" method="post" action="">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="cliente" name="cliente" type="text" placeholder="Digite o nome do cliente" class="form-control input-md" required="">
                                </div>
                            </div>
                            <!-- Text input-->
                            <div class="form-group">
