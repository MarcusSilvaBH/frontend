                    ...
                    <div class="col-md-12">
                        <div class="navbar-collapse collapse ">
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    <a class="menu-top-active" href="cadastrar_clientes.html">Cadastrar Clientes</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="cadastrar_atendente.html">Cadastrar Atendente</a>
                                </li>
                                <li>
                                    <a href="cadastrar_servico.html">Cadastrar Serviço</a>
                                </li>
                                <li>
